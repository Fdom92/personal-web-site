        ...
        <div class="footer-main">
          ...
          <div class="footer-links">
            ...
            title="This link opens my stackoverflow account in a new tab.">
              <lazy-img src="../assets/logos/logo-stackoverflow.svg" alt="Stack-overflow"/>
            </a>
          </div>
        </div>
